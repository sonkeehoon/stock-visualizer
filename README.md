# Stock Visualizer - 주식, 환율 시각화 페이지

## 워크 플로우
<img width="1925" height="164" alt="Untitled diagram-2025-10-15-100620" src="img/stock-visualizer-diagram-2025-10-30-074017.png" />

한국, 미국 시가총액 상위 100개 기업의 **실시간 주식, 정보**와

미국 달러, 유로, 일본 엔화, 중국 위안화 **환율 정보**를 크롤링하고

**히트맵, 선 그래프로 시각화**하는 Python 앱입니다.
...
1. 한국, 미국 시총 100대 기업 데이터 시각화 (네이버 금융, 야후 파이넨스)
